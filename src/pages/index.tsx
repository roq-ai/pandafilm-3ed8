  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="PandaFilm: Your Ultimate Destination for Streaming Blockbuster Movies and Shows. Dive into a World Beyond Netflix and Disney Hotstar."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1522869635100-9f4c5e86aa37?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxzdHJlYW1pbmclMjBzZXJ2aWNlfGVufDB8fHx8MTY5OTk1MTgyOXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`PandaFilm: Your Ultimate Destination for Streaming Blockbuster Movies and Shows. Dive into a World Beyond Netflix and Disney Hotstar.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Account Owner" type="default" abilities={appConfig.ownerAbilities} />
