...
import { useRoqClient, useWatchlistFindManyWithCount } from 'lib/roq';
...
export function WatchlistListPage(props: WatchlistListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useWatchlistFindManyWithCount({
  ...
  const handleDelete = async (id: string) => {
    setDeleteError(null);
    try {
      await roqClient.watchlist.delete({ where: { id } });
      await mutate();
    } catch (error) {
