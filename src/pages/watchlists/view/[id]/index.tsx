...
import { useWatchlistFindFirst, useRoqClient } from 'lib/roq';
...
function WatchlistViewPage() {
  ...
  const queryParams = useMemo<{ include: { user: boolean; movie: boolean; series: boolean } }>(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: ['user', 'movie', 'series'],
          id,
        },
        'watchlist',
      ),
  ...
  const { data, error, isLoading } = useWatchlistFindFirst(queryParams, {}, { disabled: !id });
