...
import { useProfileFindFirst, useRoqClient } from 'lib/roq';
...
function ProfileViewPage() {
  ...
  const { data, error, isLoading } = useProfileFindFirst(queryParams, {}, { disabled: !id });
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem
                  label="Birth Date"
                  text={data?.birth_date ? format(data?.birth_date, 'dd-MM-yyyy') : ''}
                />
