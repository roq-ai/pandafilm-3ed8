...
import { useRoqClient, useSeriesFindManyWithCount } from 'lib/roq';
...
export function SeriesListPage(props: SeriesListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useSeriesFindManyWithCount({
  ...
  const handleDelete = async (id: string) => {
    setDeleteError(null);
    try {
      await roqClient.series.delete({ where: { id } });
      await mutate();
    } catch (error) {
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'seasons', header: 'seasons', accessorKey: 'seasons' },
