...
import { useSeriesFindFirst, useRoqClient } from 'lib/roq';
...
function SeriesViewPage() {
  ...
  const queryParams = useMemo<{ include: { provider: boolean } }>(
    () =>
  ...
  const { data, error, isLoading } = useSeriesFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('series', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/series/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Seasons" text={data?.seasons} />
